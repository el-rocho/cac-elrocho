...
class SecretStore:
    ...
    def _protect_value(value: str) -> str:
        ...
        if os.name != "nt":
            return value
        try:
            encrypted = SecretStore._dpapi(value.encode("utf-8"), protect=True)
    ...
    @staticmethod
    def _unprotect_value(value: str) -> Optional[str]:
        ...
        try:
            ...
            plaintext = SecretStore._dpapi(encrypted, protect=False)
